 ...
 * @author romanow
 */
public class LEP500MainBase extends javax.swing.JFrame {

    /**
     * Creates new form Main
     */
    public LEP500MainBase() {
        Values.init();
        initComponents();
    ...
    public static void runGUIClass(final int appType){
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    Values.env().applicationObject(appType);
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource(Values.env().applicationName(ValuesBase.AppNameIconPath)))); // NOI18N
    ...
    private void ClientXActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ClientXActionPerformed
        runGUIClass(Values.ClassNameClient);
        //Client.main(null);
        dispose();
    ...
    private void ServerXActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ServerXActionPerformed
        runGUIClass(Values.ClassNameCabinet);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LEP500MainBase.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LEP500MainBase().setVisible(true);
            }
        });
    }
