...
import romanow.abc.desktop.EntityPanelUni;
 ...
 * @author romanow
 */
public class LEP500OfflineParamsPanel extends LEP500BasePanel {
    private final static String WinModes[]={"прямоугольник","треугольник","синус","парабола"};
    private LEP500LocalData localData;
    private LEP500Params current;
    public LEP500OfflineParamsPanel() {
        initComponents();
        }
    public void initPanel(MainBaseFrame main0){
        ...
        for(String ss : WinModes)
            WinFun.add(ss);
        localData = ((LEP500OfflineClient)main).getLocalData();
        ParamsList.removeAll();
        for(LEP500Params params : localData.getLep500ParamList())
    ...
    public void showParams(){
        if (ParamsList.getItemCount()==0)
            return;
        LEP500Params params = localData.getLep500ParamList().get(ParamsList.getSelectedIndex());
        busy=true;
    ...
    private void initComponents() {
        ...
        ParamsList = new java.awt.Choice();
        ...
        add(ParamsList);
        ParamsList.setBounds(160, 20, 300, 20);
    ...
    private void updateSettings(KeyEvent evt, String name){
        ...
        ((LEP500OfflineClient)main).saveLocalData();
    }
    ...
    private java.awt.Choice ParamsList;
